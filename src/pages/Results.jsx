...
function Results({ orderData, results, onBack, onEdit }) {
  ...
  const handleAddSkvettpallToNewCombo = () => {
    ...
    const newSkvettpall = {
      ...
      boxConfig: { 
        boxesPerRow: 8,
        heightInRedBoxUnits: 0.170588 // Default red box height ratio
      },
      stackHeight: Math.ceil(boxCount / 8), // Assuming 8 boxes per row by default
      heightInRedUnits: 1 + (Math.ceil(boxCount / 8) * 0.170588)
    };
      ...
      <div className="pallets-grid">
        ...
        <div className="pallets-section">
          ...
          <div className="section-content">
            ...
            {mixPall.length > 0 && (
              <div className="combo-pallet-item" style={{marginTop: '1rem'}}>
                <div className="combo-header">
